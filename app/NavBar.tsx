...
const NavBar = () => {
  ...
  return (
    <Flex className="w-[100%] gap-6 border-b   border-gray-200  shadow-2xs px-6 h-14 items-center  ">
      ...
      <ul className="flex gap-6   text-gray-600 items-center">
        ...
        <li>
         {session  &&  <Avatar size='2' referrerPolicy="no-referrer"  src={session?.user?.image!} radius="full" fallback='A'/>}
        </li>
